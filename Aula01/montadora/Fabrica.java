...
public class Fabrica {
  ...
  public static void main(String[] args) {
    ...
    /*
     * Carro carroDoZe = new Carro(); System.out.println("CARRO DO ZÉ:"); //setar
     * variáveis: carroDoZe.setCor("Vermelho"); carroDoZe.setMarca("VW");
     * carroDoZe.setModelo("Calhambeque");
     * System.out.println("----------------------------"); //recuperar variáveis: /*
     ...
     */
    /*
     * String resposta; resposta = "Cor: " + carroDoZe.getCor() + "\n" + "Marca: " +
     ...
     * System.out.print("Cor do carro do Jão: "); String cor = input.nextLine();
     * 
     * System.out.print("Marca do carro do Jão: "); String marca = input.nextLine();
     * System.out.print("Modelo do carro do Jão: "); String modelo =
     * input.nextLine(); //novos campos: numeroPortas; velocidadeMaxima;
     * nomeProprietario System.out.print("Num. portas do carro do Jão: "); int
     * numeroPortas = Integer.parseInt(input.nextLine()); //convertendo String para
     * Integer System.out.print("Velocidade maxima do carro do Jão: "); int
     * velocidadeMaxima = Integer.parseInt(input.nextLine()); //convertendo String
     * para Integer System.out.print("Nome do proprietário do carro do Jão: ");
     * String nomeProprietario = input.nextLine();
     * System.out.println("----------------------------"); carroDoJao.setCor(cor);
     * carroDoJao.setMarca(marca); carroDoJao.setModelo(modelo);
    ...
    /*
     * //Carro do Tiao System.out.println("----------------------------"); Carro
     * carroDoTiao = new Carro(); carroDoTiao.setCor("cor");
     * carroDoTiao.setMarca("marca"); carroDoTiao.setModelo("modelo");
     * carroDoTiao.setNumeroPortas(4); carroDoTiao.setVelocidadeMaxima(250);
     * carroDoTiao.setNomeProprietario("Tiao"); carroDoTiao.setKmRodados(1000);
     * carroDoTiao.setLitrosCombustivel(50);
     * System.out.println(carroDoTiao.toString()); //criar uma viagem: //Saí de
     * Passos e fui para Franca .. andei 90km // gastei 1/4 tanque
     * carroDoTiao.atualizaKmRodados(90); carroDoTiao.atualizaTanqueCombustivel(12);
     * System.out.println("----------------------------");
     * System.out.println("DEPOIS DA VIAGEM:");
     * System.out.println(carroDoTiao.toString());
     * System.out.println("CONSUMO DE COMBUSTÍVEL: " +
     * carroDoTiao.consumoCombustivel(90,12) + "km/l");
     * System.out.println("----------------------------");
     */
  }
